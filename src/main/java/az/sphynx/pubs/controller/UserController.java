...
import az.sphynx.pubs.bean.User;
...
public class UserController {
    ...
    @PostMapping
    public ModelAndView registerPost(@ModelAttribute @Valid az.sphynx.pubs.entity.User user, BindingResult result) {
    ...
    public ModelAndView edit(ModelAndView modelAndView) {
        az.sphynx.pubs.entity.User loggedInUser  = securityServiceInter.getLoggedInUserDetails().getUser();
        az.sphynx.pubs.entity.User user = userServiceInter.findById(loggedInUser.getId());
